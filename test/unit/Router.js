...
describe('Router', function() {
    ...
    afterEach(function() {
        if (JSON.stringify['restore']) JSON.stringify.restore();
    });
    ...
    it('should register get route', function() {
        ...
        router.routesList[0].should.have.all.keys(
            'method',
            'path',
            'options',
            'closure'
    ...
    it('cant resolve missing route', function() {
        router
            .findMatchingRoute('GET', 'missingroute')
    ...
    it('adds string as handler', function() {
        ...
        router.routesList[0].should.have
            .property('closure')
            .that.equals('Controller');
    });
    ...
    it('goes through the controller', async() => {
        let dispatch = sinon
            .stub(ControllerDispatcher, 'dispatchRoute')
            .returns(true);
    ...
    it('creates a resource', () => {
        ...
        router.routesList[0].should.have
            .property('closure')
            .that.equals('PostController@index');
        ...
        router.routesList[1].should.have
            .property('closure')
            .that.equals('PostController@show');
        ...
        router.routesList[2].should.have
            .property('closure')
            .that.equals('PostController@create');
        ...
        router.routesList[3].should.have
            .property('closure')
            .that.equals('PostController@update');
        ...
        router.routesList[4].should.have
            .property('closure')
            .that.equals('PostController@remove');
    });
});
