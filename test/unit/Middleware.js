...
const MiddlewareContainer = require('../../src/Middleware');
...
describe('Middleware Container', function() {
    ...
    it('registers a new middleware', () => {
        ...
        container.middlewaresList.should.have
            .property('test')
            .that.equals('Test/namespace');
    });
    ...
    it('register a group', () => {
        ...
        container.middlewareGroups.should.have
            .property('test-group')
    ...
    it('parse a list of middlewares', () => {
        ...
        container
            .parse(['test', 'test1', 'test2'])
            .should.deep.equal(['Test', 'Test1', 'Test2']);
    });
    ...
    it('parse a group of middlewares', () => {
        ...
        container
            .parse(['test', 'test-group', 'test-group1'])
            .should.deep.equal(['Test', 'Test', 'Test1', 'Test1', 'Test2']);
    });
