...
const Example = require('./Classes/Example');
...
describe('Ioc', function() {
    ...
    it('registers a new binding which is singleton', function() {
        ...
        containers._bindings.should.have.a
            .property('Ex/singleton')
            .that.deep.equals({
                closure: closure,
                singleton: true
            });
        containers._instances.should.have.a
            .property('Ex/singleton')
            .that.is.instanceOf(Example);
    });
    ...
    it('registers a new binding which is singleton and deferred', function() {
        ...
        containers._bindings.should.have.a
            .property('Ex/singleton/deferred')
            .that.deep.equals({
                closure: closure,
                singleton: true
            });
    ...
    it('registers a new namespace', function() {
        ...
        containers._namespaces.should.have.a
            .property('Ex/namespace')
            .that.deep.equals(Example);
    });

    it('registers a new alias', function() {
        Ioc.alias('Alias', 'Ex/namespace');

        containers._alias.should.have.a
            .property('Alias')
            .that.equals('Ex/namespace');
    });
    ...
    it('call function triggers a method of passed object with additional parameters', async() => {
        ...
        (await app().call(exampleObject, 'testFunction', [
            'good',
            'bad'
        ])).should.deep.equal({ arg1: 'good', arg2: 'bad' });
    });
